    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destiny', models.CharField(choices=[('Production', 'Production'), ('Secretariat', 'Secretariat')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('task', 'Task')], max_length=5)),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.department')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('read', models.BooleanField(default=False)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('type', models.CharField(choices=[('project', 'Project')], max_length=8)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.project')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='commentfile',
            index=models.Index(fields=['date_posted'], name='core_commen_date_po_b23c2c_idx'),
        ),
        migrations.AddIndex(
            model_name='user',
